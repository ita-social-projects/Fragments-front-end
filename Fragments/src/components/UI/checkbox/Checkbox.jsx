    ...
    return (
        <div className={stylescenter.roleCheckboxPos}>
            ...
            <div className= {stylescenter.postCheckboxRepresentative}>
                <div>
                <input onChange={props.handleOne} 
                type= "checkbox" 
                name = "representative" 
            ...
            <div>
              <input onChange={props.handleTwo} type= "checkbox" 
              name = "representative Study" value = {props.checkDataTwo} /> 
              <p>представник ЗВО</p>
            </div>
            </div>
        </div>
...
//       <div className= {stylescenter.postCheckboxRepresentative}>
//           <div>
//           <input onChange={props.handleOne} type= "checkbox" 
//           name = "representative" value = {props.checkDataOne}/> 
//           <p>представник влади</p> 
//       </div>
//       <div>
//         <input onChange={props.handleTwo} type= "checkbox" 
