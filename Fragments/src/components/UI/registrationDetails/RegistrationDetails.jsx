  ...
  return (
    <div>
      <img src={values.imageSrc} className={'img-fluid '+styles.inputPhoto} id="image-uploader" alt='upload'/>
        ...
        value={values.name} onChange={handleInputChange} placeholder="Ім'я та прізвище" required />
        <button className={styles.lastnameBtn + ' ' + applyErrorClass('name')} onClick={name => {name = 'name'; handleInputClear(name)}} >
